...
var WYSIWYMoo = new Class({
  ...
  language: new Hash({
    ...
    'link' : 'Link',
    'link_text': new Hash({ 'enterurl': 'Enter Link URL', 'linktext': 'Link Text' }),
    'image' : 'Image',
    'image_text': new Hash({ 'enter': 'Enter Image URL', 'alt': 'Image Alt Text' }),
    'html': 'HTML Preview',
    'help' : 'Help'
  }),
    ...
    this.markdown = new Showdown.converter();
      ...
      this.wrapper.wraps(this.element);
			...
			this.toolbar =	new Element('ul', {'class': 'markdown_toolbar', 'styles': {'width': d.x, 'overflow': 'hidden'}});
        ...
        'keydown':function(evnt){
          if (evnt.key == 'tab'){
            ...
            if (this.element.setSelectionRange) {
              this.gecko_tab(this.element, evnt.shift, {tabString : "    "});
            } else if (document.selection) {
              this.ie_tab(this.element, evnt.shift, {tabString : "    "});
            }
          }
        }.bind(this),
  ...
  setCaretPosition: function(pos){
    ...
    this.addButton('heading', function(evnt){
      if (this.element.setSelectionRange) {
        ...
        this.ie_tab(this.element, evnt.shift, {tabString : "# ", range: this.range});
      }
    });
    ...
    this.addButton('unordered_list', function(evnt){
      if (this.element.setSelectionRange) {
        ...
        this.ie_tab(this.element, evnt.shiftift, {tabString : "- ", range: this.range});
      }
    });

    this.addButton('ordered_list', function(evnt){
      if (this.element.setSelectionRange) {
        this.gecko_tab(this.element, evnt.shift, {tabString : "1. "});
      } else if (document.selection) {
        this.ie_tab(this.element, evnt.shiftt, {tabString : "1. ", range: this.range});
      }
    });
